...
if __name__ == "__main__":
    # Path to the .sm file
    file_path = 'j30.sm/j3010_1.sm'  # Using an existing file from the directory

    # Create parser instance and parse the file
    parser = SMFileParser()
    resource_df, project_info, precedence_df, requests_df, availability_df = parser.parse_sm_file(file_path)
